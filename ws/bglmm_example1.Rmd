...
Family sigma plot don't expect it to be too different because data is very likely to follow the distribution well. Looking for the prior and posterior to not be exactly the same. Here, posterior is much 'taller' and prior is wider.
...
tobacco.brm3 %>% hypothesis('sigma = 0', class = '') %>% plot() # leave class blank because there is no X_ in the beginning
